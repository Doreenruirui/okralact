...
[parameters](https://github.com/Calamari-OCR/calamari/blob/master/calamari_ocr/scripts/train.py
...
| Info               | --display DISPLAY                                            | Frequency of how often an output shall occur during training. If 0 < display <= 1 the display is in units  of epochs. |
